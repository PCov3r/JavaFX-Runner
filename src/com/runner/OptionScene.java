...
public class OptionScene extends Scene {
    ...
    public OptionScene(Stage primaryStage, Pane p, double v, double v1, boolean b) {
        super(p, v, v1, b);
        this.p = p;

        returnBtn = new Button("Retour");
        returnBtn.setMinWidth(150);
        returnBtn.setStyle("-fx-hover-color: red ; -fx-font-size:20px; -fx-background-color: #525252; -fx-border-color: #000000; -fx-text-fill: #ffffff ");
        ...
        jumpBtn.setStyle("-fx-hover-color: red ; -fx-font-size:20px; -fx-background-color: #525252; -fx-border-color: #000000; -fx-text-fill: #ffffff ");
        ...
        shootBtn.setStyle("-fx-hover-color: red ; -fx-font-size:20px; -fx-background-color: #525252; -fx-border-color: #000000; -fx-text-fill: #ffffff ");
